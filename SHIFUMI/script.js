...
function ouverture(){   // gère l'ouverture du rideau >> on enlève -1 à la valeur définie dans la variable largeur
    largeur -=1;
    ...
    // ici le timer s'arrête une fois que la largeur atteint 0
